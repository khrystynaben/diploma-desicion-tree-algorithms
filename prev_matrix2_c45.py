...
#--------------------Employee-(4 000 600)----------------------
train_data = pd.read_csv('emp_data/emp_train_4000.csv')  
test_data= pd.read_csv('emp_data/emp_test_600.csv') 
label = 'LeaveOrNot'

model = c45(train_data, label)
...
print("prediction: ", make_predictions(model, test_data,label))
print("Accuracy: ", evaluateС45(model,test_data,label))
