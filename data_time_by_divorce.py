...
#--------------------Divorce---------------------
#train_data_emp = pd.read_csv('data/divorce/coma_train.csv')
#print(train_data_emp)
#test_data_emp = pd.read_csv('data/divorce/coma_test.csv') 


#--------------------Divorce---------------------
train_data_emp = pd.read_csv('data/divorce/train.csv')
test_data_emp = pd.read_csv('data/divorce/test.csv') 
label = 'Divorce'
...
accuracyChaid = evaluateChaid(treeChaid, test_data_emp, label) 
