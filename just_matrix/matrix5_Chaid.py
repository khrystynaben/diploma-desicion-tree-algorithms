from _5_tree_chaid4 import chaid_tree, predict, evaluateChaid
...
model = chaid_tree(train_data,  label, class_list)
...
print("Accuracy: ", evaluateChaid(model,test_data,label))
